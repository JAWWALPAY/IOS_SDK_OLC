...
public class TZStackView: UIView {
    ...
    override public func updateConstraints() {
        ...
        for arrangedSubview in arrangedSubviews {
            ...
            if alignment != .fill {
                ...
                switch axis {
                case .horizontal:
                    guideConstraint = constraint(item: arrangedSubview, attribute: .height, toItem: nil, attribute: .notAnAttribute, constant: 0, priority: UILayoutPriority.init(25))
                case .vertical:
                    guideConstraint = constraint(item: arrangedSubview, attribute: .width, toItem: nil, attribute: .notAnAttribute, constant: 0, priority: UILayoutPriority.init(25))
                }
        ...
        if arrangedSubviews.count > 0 {
            ...
            case .fillEqually, .fill, .fillProportionally:
                ...
                if alignment == .firstBaseline && axis == .horizontal {
                    stackViewConstraints.append(constraint(item: self, attribute: .height, toItem: nil, attribute: .notAnAttribute, priority: UILayoutPriority.init(49)))
                }
            ...
            case .equalSpacing:
                ...
                switch axis {
                case .horizontal:
                    stackViewConstraints.append(constraint(item: self, attribute: .width, toItem: nil, attribute: .notAnAttribute, priority: UILayoutPriority.init(49)))
            ...
            case .equalCentering:
                ...
                stackViewConstraints += createFillEquallyConstraints(spacerViews, priority: UILayoutPriority.init(150))
                stackViewConstraints += createFillConstraints(arrangedSubviews, relatedBy: .greaterThanOrEqual, constant: spacing)
            }
    ...
    private func createSurroundingSpacerViewConstraints(_ spacerView: UIView, views: [UIView]) -> [NSLayoutConstraint] {
        ...
        var topPriority: UILayoutPriority = UILayoutPriority.init(1000)
        var topRelation: NSLayoutConstraint.Relation = .lessThanOrEqual
        
        var bottomPriority: UILayoutPriority = UILayoutPriority.init(1000)
        var bottomRelation: NSLayoutConstraint.Relation = .greaterThanOrEqual
        
        if alignment == .top || alignment == .leading {
            topPriority = UILayoutPriority.init(999.5)
            topRelation = .equal
        }
        
        if alignment == .bottom || alignment == .trailing {
            bottomPriority = UILayoutPriority.init(999.5)
        ...
        switch axis {
        case .horizontal:
            constraints.append(constraint(item: spacerView, attribute: .height, relatedBy: .equal, toItem: nil, attribute: .notAnAttribute, constant: 0, priority: UILayoutPriority.init(51)))
        case .vertical:
            constraints.append(constraint(item: spacerView, attribute: .width, relatedBy: .equal, toItem: nil, attribute: .notAnAttribute, constant: 0, priority: UILayoutPriority.init(51)))
        }
        return constraints
    }
    ...
    private func createFillProportionallyConstraints(_ views: [UIView]) -> [NSLayoutConstraint] {
        ...
        var priority: UILayoutPriority = UILayoutPriority.init(1000)
    ...
    private func createFillEquallyConstraints(_ views: [UIView], priority: UILayoutPriority = UILayoutPriority.init(1000)) -> [NSLayoutConstraint] {
        switch axis {
        case .horizontal:
    ...
    private func createFillConstraints(_ views: [UIView], priority: UILayoutPriority = UILayoutPriority.init(1000), relatedBy relation: NSLayoutConstraint.Relation = .equal, constant: CGFloat) -> [NSLayoutConstraint] {
        var constraints = [NSLayoutConstraint]()
    ...
    private func equalAttributes(views: [UIView], attribute: NSLayoutConstraint.Attribute, priority: UILayoutPriority = UILayoutPriority.init(1000)) -> [NSLayoutConstraint] {
        ...
        if views.count > 0 {
            ...
            let countDownPriority = (currentPriority < UILayoutPriority.init(1000))
            for view in views {
                if let firstView = firstView {
    ...
    private func constraint(item view1: AnyObject, attribute attr1: NSLayoutConstraint.Attribute, relatedBy relation: NSLayoutConstraint.Relation = .equal, toItem view2: AnyObject?, attribute attr2: NSLayoutConstraint.Attribute? = nil, multiplier: CGFloat = 1, constant c: CGFloat = 0, priority: UILayoutPriority = UILayoutPriority.init(1000)) -> NSLayoutConstraint {
